"""
Django settings for grupo_imperio project.
...
AUTH_USER_MODEL = 'grupo_app.Utilisateur'

ROOT_URLCONF = 'grupo_imperio.urls'
...
WSGI_APPLICATION = 'grupo_imperio.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST'),  # L'emplacement de votre base de données (localhost par défaut)
